...
//        start();
    ...
    public void start() {
        ...
        this.setBackgroundColor(getResources().getColor(R.color.bottom_button_text_gray));
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (length < 0) {
                ...
                CountdownButton.this.setBackgroundColor(getResources().getColor(R.color.colorAccent));
                clearTimer();
                length = 30 * 1000;
            }
        }
